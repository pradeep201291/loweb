...
gulp.task('build', function (callback) {
    ...
    runSequence(['tslint', 'clean-build'], 'incrementVersion', 'copyPrivateLabelConfig', 'copyAppConfig', 'createBundle',
        ['updateWebConfig', 'updatePrivateLabelConfig'],
 ...
 * Copy version file
 */
gulp.task('copyVersionFile', () => {
    var sourceFiles = ['./version.json'];
    var destination = './src/client/app/core/global-configuration/';
    gulp
        .src(sourceFiles)
        .pipe(gulp.dest(destination));
...
/**
 * Task for replacing variables privatelabel json file. This task also copy these files to dis folder
 */

gulp.task('updatePrivateLabelConfig', () => {
    gulp.src([gulpConfig.filePaths.privateLabel.src])
